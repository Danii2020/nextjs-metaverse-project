  ...
  >
    ...
    >
      ...
      <motion.p
        ...
        sm:text-[32px] text-[20px] text-center
      ...
      >
        ...
        >
          Metaverse
        </span> is a new thing in the future,
        ...
        this is really the <span
          className="font-extrabold text-white"
        >
          madness of the metaverse
        </span> of today, using only <span
          className="font-extrabold text-white"
        >
          VR
        </span> devices you can easily <span
          className="font-extrabold text-white"
        >
          explore
